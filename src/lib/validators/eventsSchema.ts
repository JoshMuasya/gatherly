...
export const createEventSchema = z.object({
    ...
    maxAttendees: z.number().min(0, "Max attendees cannot be negative (use 0 for unlimited)"),
...
export const updateEventSchema = z.object({
    ...
    maxAttendees: z.number().min(0, "Max attendees cannot be negative (use 0 for unlimited)").optional(),
